...
# ---------------Frames Secundarios---------------------------
        ...
        self.frame_to_do_container.grid(row=1, column=0, ipady=10, rowspan=6,
                                        padx=20, sticky="nsew")
        ...
        self.frame_to_do_container.rowconfigure((0, 1, 2, 3, 4, 5, 6),
                                                weight=1)
...
# -------------Widgets-----------------------------
        ...
        self.entry_task_1 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_1.grid(row=1, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.entry_task_2 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_2.grid(row=2, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.entry_task_3 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_3.grid(row=3, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.entry_task_4 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_4.grid(row=4, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.entry_task_5 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_5.grid(row=5, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.entry_task_6 = customtkinter.CTkEntry(master=self.frame_to_do_container,
                                                   ...
                                                   border_width=0,
                                                   corner_radius=15)
        self.entry_task_6.grid(row=6, column=0, columnspan=2, pady=5, padx=20,
                               sticky="W")
        ...
        self.progressbar.grid(row=0, column=0, columnspan=3, padx=20,
                              sticky="SW")
        ...
        self.button_reset = customtkinter.CTkButton(master=self.frame_repstart,
                                                    ...
                                                    fg_color="#FFFFFF")
        self.button_reset.grid(row=0, column=1, columnspan=1, pady=1, padx=5,
                               sticky="NE")
        ...
        self.button_start = customtkinter.CTkButton(master=self.frame_repstart,
                                                    ...
                                                    text_font=("pomodoring_font", 50),
                                                    fg_color="#FFFFFF")
        self.button_start.grid(row=0, column=0, columnspan=1, pady=1, padx=5,
                               sticky="NW")
        ...
        self.update_name.grid(row=0, column=1, columnspan=1, pady=15, padx=10,
                              sticky="S")
        ...
        self.update_wlabel.grid(row=0, column=2, columnspan=1, pady=15, padx=1,
                                sticky="S")
        ...
        self.music_name_label = customtkinter.CTkLabel(master=self.frame_music,
                                                       ...
                                                       "NING TO LO-FI MUSIC",
                                                       text_font=("pomodoring_font", 15))
        self.music_name_label.grid(row=0, column=0, columnspan=2, ipady=10,
                                   padx=50, pady=1, sticky="S")
...
# ---------------Functions------------------------
    ...
    def play_music(self):
        ...
        pygame.mixer.music.load(self.complete_path("/OnBourbonStreet"
